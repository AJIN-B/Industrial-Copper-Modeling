...
<div style='text-align:center'>
    <h1 style='color:#6F36AD;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                st.write( f'<h5 style="color:#6F36AD;">NOTE: Min & Max given for reference, you can enter any value</h5>', unsafe_allow_html=True )
